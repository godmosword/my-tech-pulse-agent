  ...
  return (
    <aside className="hidden lg:sticky lg:top-10 lg:block lg:self-start lg:pr-4">
      <Link href="/" className="block pb-8">
        <span className="block font-serif text-[26px] font-semibold leading-none tracking-[-0.02em] text-ink">
          Tech Pulse
        </span>
        <span className="mt-2 block font-sans text-kicker font-semibold uppercase tracking-[0.12em] text-ink-soft">
          科技脈搏
        </span>
      </Link>
      ...
      <nav
        aria-label="Primary"
        className="flex flex-col gap-3 font-sans text-kicker font-semibold uppercase tracking-[0.12em] text-ink-soft"
      >
      ...
      <div className="mt-10 border-t border-rule pt-6">
        <p className="mb-3 font-sans text-kicker font-semibold uppercase tracking-[0.12em] text-ink-faint">
          顯示模式
        </p>
        <ThemeToggle />
      </div>
