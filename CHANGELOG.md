...
### Docs
- **可啟用清單**：[`docs/ENABLEMENT_CHECKLIST.md`](docs/ENABLEMENT_CHECKLIST.md) 集中列出所有 shadow / 預設 off 旗標（排程、語義去重 shadow→drop、prefilter、Finnhub / FMP vendor、news takeaway）的現況、啟用前置、風險、回滾與建議節奏；README 加指標連結。
